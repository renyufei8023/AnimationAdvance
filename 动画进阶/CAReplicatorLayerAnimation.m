...
@implementation CAReplicatorLayerAnimation

+ (CALayer *)CircleAnimation
{
    ...
    animationGroup.animations = @[[CAReplicatorLayerAnimation alphaAnimation],[CAReplicatorLayerAnimation scaleAnimation]];
...
+ (CALayer *)WaveAnimation
{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    [shape addAnimation:[CAReplicatorLayerAnimation scaleAnimation1] forKey:@"scaleAnimation"];
...
+ (CALayer *)TriangleAnimation
{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    shape.lineWidth = 1;
    [shape addAnimation:[CAReplicatorLayerAnimation rotationAnimation:transX] forKey:@"rotateAnimation"];
...
+ (CALayer *)GridAnimation
{
    ...
    CAAnimationGroup *animationGroup = [CAAnimationGroup animation];
    animationGroup.animations = @[[CAReplicatorLayerAnimation scaleAnimation1], [CAReplicatorLayerAnimation alphaAnimation]];
